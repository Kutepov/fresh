...
namespace common\components\scrapers\sources\gb\Dailystar;
...
/**
 * Class Scraper
 * @package common\components\scrapers\sources\gb\Dailystar;
 *
 * @Config (
 * timezone="Europe/London", urls={
 * "https://www.dailystar.co.uk/news/latest-news/",
 * "https://www.dailystar.co.uk/news/politics/",
 * "https://www.dailystar.co.uk/news/",
 * "https://www.dailystar.co.uk/tech/",
 * "https://www.dailystar.co.uk/showbiz/",
 * "https://www.dailystar.co.uk/sport/"
 * })
 */
class Scraper extends \common\components\scrapers\common\Scraper implements ArticleBodyScraper
{
    ...
    public function parseArticleBody(string $url): PromiseInterface
    {
        return $this->sendAsyncRequestWithProxy(new Request('GET', $url))->then(function (ResponseInterface $response) {
            ...
            return $this->XPathParser->parseDescription($html, '//p[@class="sub-title"]');
        });
    }
    ...
    public function parseArticlesList(string $url): PromiseInterface
    {
        return Coroutine::of(function () use ($url) {
            ...
            $selector = "//main[@class='mod-pancakes']";
            $articlesNode = $html->filterXPath($selector);
            $articles = $articlesNode->filterXPath("//div[@class='teaser']");
            ...
            for ($i = $articles->count() - 1; $i >= 0; --$i) {
                $node = $articles->eq($i);
                try {
                    $linkNode = $node->filterXPath("//a[@class='headline']");
                    if (!$linkNode->count()) {
                        continue;
                    }
