...
namespace common\components\scrapers\sources\gb\TheSun;
...
/**
 * Class Scraper
 * @package common\components\scrapers\sources\gb\TheSun;
 *
 * @Config (
...
class Scraper extends \common\components\scrapers\common\Scraper implements ArticleBodyScraper
{
    ...
    public function parseArticlesList(string $url): PromiseInterface
    {
        return Coroutine::of(function () use ($url) {
            ...
            $selector = "//*[contains(@class, 'sun-container__home-section')]";
            $articlesNode = $html->filterXPath($selector);
            $articles = $articlesNode->filterXPath("//div[contains(@class, 'teaser-item')]");
            ...
            for ($i = $articles->count() - 1; $i >= 0; --$i) {
                $node = $articles->eq($i);
                try {
                    $linkNode = $node->filterXPath("//div[contains(@class, 'teaser__copy-container')]//a");
                    if (!$linkNode->count()) {
                        continue;
                    }
                    $pageLink = $linkNode->attr('href');
                    $title = $linkNode->filterXPath('//p')->text();
