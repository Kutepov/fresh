...
namespace common\components\scrapers\sources\br\Uai;
...
/**
 * Class Scraper
 * @package common\components\scrapers\sources\br\Uai;
 *
 * @Config (
...
class Scraper extends \common\components\scrapers\common\Scraper implements ArticleBodyScraper
{
    ...
    public function parseArticlesList(string $url): PromiseInterface
    {
        return Coroutine::of(function () use ($url) {
            ...
            $selector = "//div[@id='search-results-item']";
            $articlesNode = $html->filterXPath($selector);

            $articles = $articlesNode->filterXPath("//div[contains(@class, 'news-box free')]");
            ...
            for ($i = $articles->count() - 1; $i >= 0; --$i) {
                $node = $articles->eq($i);
                try {
                    $linkNode = $node->filterXPath("//p[contains(@class, 'h4')]//a");
                    ...
                    $hashPreview = $this->previewHelper->getOgImageUrlHash($html, 'estado-de-minas-imgage');
