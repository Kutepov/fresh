...
namespace common\components\scrapers\sources\gb\Birminghammail;
...
/**
 * Class Scraper
 * @package common\components\scrapers\sources\gb\Birminghammail;
 *
 * @Config (
 * timezone="Europe/London", urls={
 * "https://www.birminghammail.co.uk/motoring/",
 * "https://www.birminghammail.co.uk/news/uk-news/",
 * "https://www.business-live.co.uk/all-about/west-midlands",
 * "https://www.birminghammail.co.uk/news/showbiz-tv/"
 * })
 */
class Scraper extends \common\components\scrapers\common\Scraper implements ArticleBodyScraper
{
    ...
    public function parseArticleBody(string $url): PromiseInterface
    {
        return $this->sendAsyncRequestWithProxy(new Request('GET', $url))->then(function (ResponseInterface $response) {
            ...
            return $this->XPathParser->parseDescription($html, '//div[@class="article-body"]//p[1]');
        });
    }
    ...
    public function parseArticlesList(string $url): PromiseInterface
    {
        return Coroutine::of(function () use ($url) {
            ...
            $articles = $articlesNode->filterXPath("//div[@class='teaser teaser-highlight teaser-prominent']|//div[@class='teaser']");
            ...
            for ($i = $articles->count() - 1; $i >= 0; --$i) {
                $node = $articles->eq($i);
                try {
                    $linkNode = $node->filterXPath("//a[contains(@class, 'headline')]");
